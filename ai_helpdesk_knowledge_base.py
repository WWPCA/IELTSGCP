...
RESPONSE_TEMPLATES = {
    ...
    "refund_request_with_empathy": "I understand your frustration, and I genuinely want to help. As per our Terms and Conditions, we maintain a strict no-refund policy for all purchases, which was clearly stated at the time of registration and before completing your purchase. However, if you experienced a verified technical failure during your assessment (such as system errors, incomplete processing, or platform malfunction), we can certainly investigate that for you. Could you please describe what happened during your assessment?",
